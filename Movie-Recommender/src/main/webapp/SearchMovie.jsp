    ...
    <%}%>
    	...
    	<table>
    		...
    		try{
    			...
    			ResultSet rs = st.executeQuery("select * from movies where mname like '%"+search+"%' or genre like '%"+search+"%' or stars like '%"+search+"%' or director like '%"+search+"%'");
    			while(rs.next()){
    				//System.out.println("RS - > "+ rs.getString("id"));
    		%>
    			<tr>
    				<td><%= rs.getString("id") %></td>
    				<td><a href="RateMovie.jsp"><%= rs.getString("mname") %></a></td>
